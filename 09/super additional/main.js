...
//             let hUser = document.createElement('h3');
//             hUser.innerText = user[key];
//             div.appendChild(hUser)
//         } else {
//             for (const item in user[key]) {
//                 let hItem = document.createElement('h2')
//                 hItem.innerText = user[key][item];
//                 div.appendChild(hItem);
//             }
//         }
//     }
...
//             divUser.innerText = user[key];
//             div.appendChild(divUser)
//         } else {
//             for (const item in user[key]) {
//                 let divItem = document.createElement('div')
//                 divItem.innerText = user[key][item];
...
for (const rule of rules) {
    ...
    divRule.append(divTitle, divBody);
    allDiv.appendChild(divRule);
}
